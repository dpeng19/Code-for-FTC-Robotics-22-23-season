...
//@Config
@Disabled
@TeleOp(name = "TeleOpAutoDrive", group = "TeleOp")
public class TeleOpAutoDrive extends LinearOpMode {
 ...
 */
    ...
    private final Pose2d lowBackStart = new Pose2d(-24, -35.5, Math.toRadians(-90));
    private final Pose2d medBackStart = new Pose2d(-11, -25, Math.toRadians(-180));
    private final Pose2d highBackStart = new Pose2d(-12.5, -24, Math.toRadians(0));
    private final Pose2d highScoreStartAlt = new Pose2d(-10, -58, Math.toRadians(0));
    private final Pose2d highBackStartAlt = new Pose2d(-12, -23.5, Math.toRadians(0));
                ...
                case MANUAL:
                    ...
                    if(gamepad2.x){
                        ...
                        if(!clawOpen){
                            ...
                            drive.setMode(DcMotor.RunMode.RUN_WITHOUT_ENCODER);
                            drive.setPoseEstimate(lowBackStart);
                            drive.followTrajectorySequenceAsync(lowBack);
                            driveState = DriveState.AUTO;
                            targetHead = 180;
                        }
                    }
                        ...
                        if(!clawOpen){
                            ...
                            drive.setMode(DcMotor.RunMode.RUN_WITHOUT_ENCODER);
                            drive.setPoseEstimate(medBackStart);
                            drive.followTrajectorySequenceAsync(medBack);
                            driveState = DriveState.AUTO;
                            targetHead = 180;
                        }
                    }
                        ...
                        if(!clawOpen){
                            ...
                            drive.setMode(DcMotor.RunMode.RUN_WITHOUT_ENCODER);
                            //change to other high path when applicable
                            drive.setPoseEstimate(highBackStartAlt);
