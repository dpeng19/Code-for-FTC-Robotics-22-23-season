...
public class RedLeftAuto extends LinearOpMode {
    ...
    Pose2d startPose = new Pose2d(-33.2, -63.5, Math.toRadians(180));
 ...
 */
        ...
        TrajectorySequence traj1 = drive.trajectorySequenceBuilder(startPose)
                ...
                .splineToConstantHeading(new Vector2d(-13.1, -55.5), Math.toRadians(0))//set up closer to center
                .setAccelConstraint(new TrajectoryAccelerationConstraint() {
                    @Override
                    public double get(double v, @NonNull Pose2d pose2d, @NonNull Pose2d pose2d1, @NonNull Pose2d pose2d2) {
                        return 30;
        ...
        TrajectorySequence traj3 = drive.trajectorySequenceBuilder(traj2.end())
                ...
                .splineToConstantHeading(new Vector2d(-20, -12.7), Math.toRadians(180))
                .setAccelConstraint(new TrajectoryAccelerationConstraint() {
                    @Override
                    public double get(double v, @NonNull Pose2d pose2d, @NonNull Pose2d pose2d1, @NonNull Pose2d pose2d2) {
                        return 30;
        ...
        TrajectorySequence traj4 = drive.trajectorySequenceBuilder(traj3.end())
                .lineToLinearHeading(new Pose2d(-48.9, -12.5, Math.toRadians(-90.5)))
                .build();
        TrajectorySequence traj5 = drive.trajectorySequenceBuilder(traj4.end())
                .lineToLinearHeading(new Pose2d(-59, -12.3, Math.toRadians(180)))//change back to x = -59.5 if inconsistent
                .build();
        TrajectorySequence traj6 = drive.trajectorySequenceBuilder(traj5.end())
                .lineToLinearHeading(new Pose2d(-49.1, -12.5, Math.toRadians(-90.5)))//change back to y = -12.7 if inconsistent
                .build();
        TrajectorySequence traj7 = drive.trajectorySequenceBuilder(traj6.end())
                .lineToLinearHeading(new Pose2d(-59, -12.1, Math.toRadians(180)))//change back to x = -59.5 if inconsistent
                .build();
        TrajectorySequence traj8 = drive.trajectorySequenceBuilder(traj7.end())
                .lineToLinearHeading(new Pose2d(-49, -12.7, Math.toRadians(-90.5)))//change back to y = -12.7 if inconsistent
                .build();
        ...
        TrajectorySequence traj10 = drive.trajectorySequenceBuilder(traj9.end())
                .lineToLinearHeading(new Pose2d(-49, -12.8, Math.toRadians(-90.5)))//change back to y = -12.7 if inconsistent
                .build();
