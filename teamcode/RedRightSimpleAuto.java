...
@Disabled
@Autonomous(name = "RedRightSimpleAuto")
public class RedRightSimpleAuto extends LinearOpMode {
    ...
    Pose2d startPose = new Pose2d(32, -63.5, Math.toRadians(0));
 ...
 */
        ...
        TrajectorySequence traj1 = drive.trajectorySequenceBuilder(startPose)
                .setReversed(true)
                .splineToConstantHeading(new Vector2d(13, -55.5), Math.toRadians(180))//set up closer to center
        ...
        TrajectorySequence traj3 = drive.trajectorySequenceBuilder(traj2.end())
                .strafeLeft(5.75)
                .splineToConstantHeading(new Vector2d(20, -12.3), Math.toRadians(0))
                .forward(39.3)
                .build();
        TrajectorySequence traj4 = drive.trajectorySequenceBuilder(traj3.end())
                .lineToLinearHeading(new Pose2d(48.6, -12.4, Math.toRadians(-89)))
                .build();
        ...
        TrajectorySequence loc3 = drive.trajectorySequenceBuilder(traj4.end())
                .strafeLeft(3)
                .splineToConstantHeading(new Vector2d(59, -36.5), Math.toRadians(-90))
