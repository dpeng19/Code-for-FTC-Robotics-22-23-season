...
@Disabled
@Autonomous(name = "RedRightSimple")
public class RedRightSimple extends LinearOpMode {
    ...
    Pose2d startPose = new Pose2d(38.5, -63.5, Math.toRadians(180));
 ...
 */
        ...
        TrajectorySequence traj2 = drive.trajectorySequenceBuilder(traj1.end())
                ...
                .strafeRight(34.5)
                .build();
        TrajectorySequence loc1 = drive.trajectorySequenceBuilder(traj2.end())
                .back(2)
                .turn(Math.toRadians(-90))
                .build();
        TrajectorySequence loc2 = drive.trajectorySequenceBuilder(traj2.end())
                .splineToSplineHeading(new Pose2d(24, -13, Math.toRadians(90)), Math.toRadians(0))
                .strafeRight(12)
                .build();
        TrajectorySequence loc3 = drive.trajectorySequenceBuilder(traj2.end())
                .splineToSplineHeading(new Pose2d(24, -13, Math.toRadians(90)), Math.toRadians(0))
                .strafeRight(35)
                .back(23)
                .build();
        ...
        while (opModeIsActive() && !isStopRequested()) {
            ...
            switch (liftState) {
                case START:
                    ...
                    if (trajstate == TrajectoryState.TRAJ_2) {
                ...
                case STACK:
                    if (StackTimer.seconds() >= STACK_TIME) { //may have to reduce STACK_TIME for optimization
                        ...
                        if(trajstate != TrajectoryState.TRAJ_3) {
