...
//@Config
@TeleOp(name = "BetterTeleOpRight", group = "TeleOp")
public class BetterTeleOpRight extends LinearOpMode {
    ...
    public static double pwr_Mult = 0.8; //speed of robot, ranges from -1 to 1, adjust closer to 1 for faster speed
    ...
    private final Pose2d medToMedLowBackStart = new Pose2d(11, -25, Math.toRadians(0));
    private final Pose2d highToLowMedBackStart = new Pose2d(12.5, -24, Math.toRadians(180));
    private final Pose2d highScoreStartAlt = new Pose2d(10, -58, Math.toRadians(180));
    private final Pose2d highToHighBackStart= new Pose2d(12, -23.5, Math.toRadians(180));
    ...
    public void runOpMode() {
        ...
        //LOW-THERE
        TrajectorySequence lowScore = drive.trajectorySequenceBuilder(collectPose)
                .setReversed(true)
                .back(12)
                .splineToConstantHeading(new Vector2d(26.5, -39.5), Math.toRadians(0))
                .build();
        //LOW-BACK
        TrajectorySequence lowToLowMedBack =  drive.trajectorySequenceBuilder(lowToLowMedBackStart)
                .strafeRight(4)
                .splineToConstantHeading(new Vector2d(12, -57), Math.toRadians(-90))
                .build();
        //MED-THERE
        TrajectorySequence medScore = drive.trajectorySequenceBuilder(collectPose)
                .back(12)
                .lineToLinearHeading(new Pose2d(11.5, -25, Math.toRadians(0)))
                .build();

        //MED-BACK
        TrajectorySequence medToMedLowBack = drive.trajectorySequenceBuilder(medToMedLowBackStart)
                .lineToLinearHeading(new Pose2d(13, -34,  Math.toRadians(-89)))
                .forward(22.5)
                .build();

        //HIGH-THERE
        TrajectorySequence highScore = drive.trajectorySequenceBuilder(collectPose)
                .back(18)
                .lineToLinearHeading(new Pose2d(13.2, -25.5, Math.toRadians(-180)))
                .build();


        //HIGH-BACK
        TrajectorySequence highToLowMedBack = drive.trajectorySequenceBuilder(highToLowMedBackStart)
        ...
        //HIGH-THERE-ALT
        TrajectorySequence highScoreAlt = drive.trajectorySequenceBuilder(highScoreStartAlt)
                .setReversed(true)
        ...
        //HIGH-BACK-ALT
        TrajectorySequence highToHighBack = drive.trajectorySequenceBuilder(highToHighBackStart)
                .setReversed(true)
 ...
 */
            ...
            //telemetry.addData("avg loopTime",loopTime.milliseconds() / loop );
            telemetry.update();
